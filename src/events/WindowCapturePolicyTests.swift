...
final class WindowCapturePolicyTests: XCTestCase {
    ...
    // every distinct opaque bounding box measured on macOS 26 with Stage Manager on, from
    // notes/stage-manager/smsig_raw_sample.txt. Good captures cluster at >=24/32, junk at <=15/32.
